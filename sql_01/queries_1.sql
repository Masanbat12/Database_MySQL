...
-- ###
mysql> insert into sub (name, age, mark1, mark2, mark3) values ("a1", 18, 80, 67, 81);
-- Query OK, 1 row affected (0.00 sec)
mysql> insert into sub (name, age, mark1, mark2, mark3) values ("a2", 20, 58, 50, 20);
-- Query OK, 1 row affected (0.00 sec)
mysql> insert into sub (name, age, mark1, mark2, mark3) values ("a3", 25, 55, 60, 30);
-- Query OK, 1 row affected (0.00 sec)
mysql> insert into sub (name, age, mark1, mark2, mark3) values ("a4", 15, 89, 80, 12);
-- Query OK, 1 row affected (0.00 sec)
mysql> insert into sub (name, age, mark1, mark2, mark3) values ("a5", 19, 89, 80, 12);
-- Query OK, 1 row affected (0.00 sec)
...
-- +----------+------+-------+-------+-------+-------+
-- | a1   |   18 |    80 |    67 |  NULL |  NULL |
-- | a2   |   20 |    58 |    50 |  NULL |  NULL |
-- | a3  |   25 |    55 |    60 |  NULL |  NULL |
-- | a4 |   19 |    89 |    80 |  NULL |  NULL |
-- +----------+------+-------+-------+-------+-------+
-- 4 rows in set (0.00 sec)
