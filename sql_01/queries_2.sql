...
-- ###
mysql> insert into flights values ("F16", "BDQ", "ILX", 2000, "11:30:00", "12:45:00");
-- Query OK, 1 row affected (0.00 sec)
mysql> insert into flights values ("F16", "CIA", "BDQ", 2000, "1:30:00", "2:45:00");
-- Query OK, 1 row affected (0.00 sec)
mysql> insert into flights values ("F15", "DL", "BDQ", 2000, "2:30:00", "4:30:00");
-- Query OK, 1 row affected (0.00 sec)
mysql> insert into flights values ("F16", "BDQ", "COM", 2000, "5:30:00", "8:30:00");
-- Query OK, 1 row affected (0.00 sec)
mysql> insert into flights values ("F15", "ILX", "COM", 2000, "6:30:00", "9:30:00");
-- Query OK, 1 row affected (0.00 sec)
...
-- +------+-----------+---------+----------+----------+----------+-------+
-- | F16 | BDQ       | ILX     |     2000 | 11:30:00 | 12:45:00 |  NULL |
-- | F16 | CIA       | BDQ     |     2000 | 01:30:00 | 02:45:00 |  NULL |
-- | F15 | DL        | BDQ     |     2000 | 02:30:00 | 04:30:00 |  NULL |
-- | F16 | BDQ       | COM     |     2000 | 05:30:00 | 08:30:00 |  NULL |
-- | F15 | ILX       | COM     |     2000 | 06:30:00 | 09:30:00 |  NULL |
-- +------+-----------+---------+----------+----------+----------+-------+
...
-- +------+-----------+---------+----------+----------+-------+
-- | F16 | BDQ       | ILX     | 11:30:00 | 12:45:00 |  NULL |
-- | F16 | CIA       | BDQ     | 01:30:00 | 02:45:00 |  NULL |
-- | F15 | DL        | BDQ     | 02:30:00 | 04:30:00 |  NULL |
-- | F16 | BDQ       | COM     | 05:30:00 | 08:30:00 |  NULL |
-- +------+-----------+---------+----------+----------+-------+
...
-- | F16 | BDQ       | ILX     | 11:30:00 | 12:45:00 |  NULL |
-- | F16 | CIA       | BDQ     | 01:30:00 | 02:45:00 |  NULL |
-- | F15 | DL        | BDQ     | 02:30:00 | 04:30:00 | 10000 |
-- | F16 | BDQ       | COM     | 05:30:00 | 08:30:00 |  NULL |
-- +------+-----------+---------+----------+----------+-------+
-- 4 rows in set (0.00 sec)
